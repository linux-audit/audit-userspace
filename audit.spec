...
%build
%configure --sbindir=/sbin --libdir=/%{_lib} --with-python=yes --with-python3=yes --with-golang --with-libwrap --enable-gssapi-krb5=yes --with-libcap-ng=yes --with-zos \
%if %{WITH_SYSTEMD}
	--enable-systemd
%endif
...
%changelog
* Tue Apr 28 2015 Steve Grubb <sgrubb@redhat.com> 2.4.3-1
