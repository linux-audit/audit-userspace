...
%attr(755,root,root) %dir %{_tmpfilesdir}/audit.conf/
%attr(640,root,root) %{_tmpfilesdir}/audit.conf/audit-tmpfiles.conf
...
%changelog
* Thu Aug 08 2024 Steve Grubb <sgrubb@redhat.com> 4.0.3-1
